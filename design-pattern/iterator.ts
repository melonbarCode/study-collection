...
public class Array2 implements Aggregator {
    private items: Items[];
...
public class ArrayInterator implements Iterator2 {
...
function main() {
    ...
    const items = [new Item("CPU", 1000), new Item("KEY", 2000), new Item("Mouse", 3000), new Item("HDD", 4000)]
